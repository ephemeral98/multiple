...
const TestTon: FC<{}> = () => {
  ...
  const fetchAccountData = async () => {
    ...
    const address = Address.parse('EQB58QagLwZHLi-wI-9w1l_Z6OMslZJBB_GcgLezH70Rq62x');
    ...
    // const address2 = new TonWeb.utils.Address('EQB58QagLwZHLi-wI-9w1l_Z6OMslZJBB_GcgLezH70Rq62x');
